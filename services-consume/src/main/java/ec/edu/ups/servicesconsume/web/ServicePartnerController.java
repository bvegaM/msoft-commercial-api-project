...
public class ServicePartnerController {
    ...
    @GetMapping("/servicePartners/{serviceId}")
    ...
    @GetMapping("/servicePartners/code/{serviceCode}")
    ...
    @PostMapping("/api/v1/services/{service_name}/users")
    ...
    @PostMapping("/api/v1/services/{service_name}/contract")
    ...
    @GetMapping("/api/v1/services/{service_name}/contract")
    ...
    @GetMapping("/api/v1/services/{service_name}/promotions")
    ...
    @GetMapping("/api/v1/services/{user_dni}")
